...
# Define a route for handling POST requests to '/get_data'
...
def get_data():
    ...
    for item in data:
        ...
        while i < len(filtered_words) - count:
            if filtered_words[i].isnumeric():
                ...
                count += 1
            i += 1
        # Add posts to regular school topics
    ...
    for i in range(5):
        ...
        del json_data[key]
        inverse.pop()
    # Return string representation of json of final_data
